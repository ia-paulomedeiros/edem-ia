-- =============================================================================
-- apply_all.sql — 001..013 concatenadas, para colar de uma vez no SQL Editor do Supabase.
...
-- >>>>>>>>>>>>>>>>>>>>>>>>>> supabase/011_caso_completo.sql
...
-- >>>>>>>>>>>>>>>>>>>>>>>>>> supabase/012_fila_por_lead.sql
...
-- >>>>>>>>>>>>>>>>>>>>>>>>>> supabase/013_fluxo_laquila.sql
