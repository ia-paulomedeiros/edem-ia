#!/usr/bin/env bash
# Aplica 001..009 duas vezes (idempotência) num PostgreSQL 16 local e roda o smoke test.
...
for round in 1 2; do
  for f in supabase/001_schema.sql supabase/002_dominio_juridico.sql supabase/003_caso_unico.sql supabase/004_dashboard.sql supabase/005_funil.sql supabase/006_dashboard_periodo.sql supabase/007_fila.sql supabase/008_configuracoes.sql supabase/009_marketing.sql; do
